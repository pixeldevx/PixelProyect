...
import { FileText, Search, ExternalLink, CheckCircle, DollarSign } from 'lucide-react';
    ...
    <DashboardLayout>
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-slate-500 mt-1">Gestiona la facturación y cobros de tus proyectos.</p>
        </div>
      </div>
                ...
                filteredProjects.map((project) => (
                  <TableRow key={project.id} className="hover:bg-slate-50/50">
                    ...
                    <TableCell className="text-right">
                      <Link href={`/projects/${project.id}?tab=billing`}>
